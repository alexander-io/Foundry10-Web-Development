(function(){
  ...
  let curr_program_panel
  let curr_research_panel
  ...
  let tree = {
    ...
    let animate_lower_links = function(){
      ...
      setTimeout(function(){
        ...
        banner_sub_item_02.classList.remove('fadeIn')
        banner_sub_item_03.classList.remove('animated')
        banner_sub_item_03.classList.remove('fadeIn')
      ...
      for (let x = 0; x < articles.length; x++) {
        ...
        content_row.style.maxHeight = '150px'
          ...
          content_row_col_child.className = 'col s12'
            ...
            content_row_col_child_para.innerHTML = truncate(tree[branch][the_array_of_glory[info_banner_xy_array_position_tuple.super][info_banner_xy_array_position_tuple.sub]].articles[x].text, 17)
    ...
    carousel_right_arrow.addEventListener('click', function(e) {
      ...
      */
      ...
      console.log('global_lst_of_carousel_panels_research_update size :', x);
